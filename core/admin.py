...
class TripAdmin(admin.ModelAdmin):
    list_display = ('trip_spot', 'group', 'destination', 'price', 'duration','trip_priority', 'destination_priority','group_priority')
    search_fields = ('trip_spot', 'destination')
    list_filter = ('group', 'duration')
    ordering = ('trip_spot',)
    inlines = [TripImageInline]
    list_editable = ['trip_priority', 'destination_priority','group_priority']
